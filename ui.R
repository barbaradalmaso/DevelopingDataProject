...
shinyUI(pageWithSidebar(
        ...
        sidebarPanel(
                ...
                submitButton('Submit'),
                br(),
                p(strong(em("Github repository:",a("Diamond price",href="https://github.com/barbaradalmaso/DevelopingDataProject/")))),
                p(strong(em("Follow me on Twitter:",a("@sciencebarb",href="https://twitter.com/sciencebarb/"))))
